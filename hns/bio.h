...
static _inline uint8_t
get_u8(const uint8_t *data) {
  return data[0];
}

static _inline uint16_t
...
static _inline int8_t
get_i8(const uint8_t *data) {
  return get_u8(data);
}

static _inline int16_t
get_i16(const uint8_t *data) {
  return get_u16(data);
}

static _inline int32_t
get_i32(const uint8_t *data) {
  return get_u32(data);
}

static _inline int64_t
